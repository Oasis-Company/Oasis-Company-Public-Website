import { onRequest as __apply_api_debug_js_onRequest } from "D:\\github projects\\Oasis Company Public Website\\functions\\apply\\api\\debug.js"
...
export const routes = [
    {
      ...
      method: "",
      middlewares: [],
      modules: [__apply_api_debug_js_onRequest],
    },
  {
